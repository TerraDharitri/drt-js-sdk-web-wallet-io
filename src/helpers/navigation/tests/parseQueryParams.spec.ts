...
describe('ParseQueryParams tests', () => {
  const searchStrings: { [key: string]: any } = {
    '?address=drt1&callbackUrl=https://localhost:3001/dashboard': {
      address: 'drt1',
    ...
    '?message=Hello!&callbackUrl=https%3A%2F%2Fdevnet.template-dapp.dharitri.org%2Fdashboard%3FsessionId%3D1721325208630%23sign-message': {
      callbackUrl: 'https://devnet.template-dapp.dharitri.org/dashboard?sessionId=1721325208630#sign-message',
      message: 'Hello!'
    },
  };
