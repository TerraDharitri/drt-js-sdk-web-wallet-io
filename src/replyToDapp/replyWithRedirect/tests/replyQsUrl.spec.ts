...
describe('replyQsUrl tests', () => {
  ...
  test('adds qsStr at the end', () => {
    ...
    ).toBe('https://wallet.dharitri.org/?param1=value&param2=value');
  });
  ...
  test('adds qsStr and keeps existing hash', () => {
    ...
    ).toBe('https://wallet.dharitri.org/?param1=value&param2=value#test');
  });
  ...
  test('keeps existing urlParams and adds qsStr', () => {
    ...
    ).toBe('https://wallet.dharitri.org/?page=1&param1=value&param2=value');
  });
  ...
  test('keeps existing hash and adds qsStr', () => {
    expect(
      ...
      'https://wallet.dharitri.org/?page=1&param1=value&param2=value#logs'
    );
  });
});
